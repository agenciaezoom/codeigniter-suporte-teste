<div class="col-xs-12 gallery-images chunk">
    <?php if( isset($label) ){ ?>
    ...
    if (!isset($viewUnit)){ ?>
        ...
        <div class="fileupload-buttonbar">
            <div class="file-controllers">
                <span class="btn btn-success fileinput-button" data-type="videos">
                    <i class="glyphicon glyphicon-plus"></i>
                    <span><?php echo T_('Adicionar Imagens'); ?></span>
                    <input type="file" name="<?php echo isset($typeGallery) && !is_null($typeGallery) ? $typeGallery : 'videos[]'; ?>" class="fileUploadImage" multiple>
                </span>
    ...
    <?php }
    $newTypeGallery = str_replace('[]', '', isset($typeGallery) && !is_null($typeGallery)  ? $typeGallery : 'videos'); ?>
    <div class="imageOlds imagesAll deleteIndividual <?php echo isset($multilang) && $multilang && is_array($languages) ? ' multilang ' : ''; echo $newTypeGallery; echo (isset($viewUnit) && $viewUnit) ? ' only-view ' : ''; ?>" data-gallerytype="<?php echo $newTypeGallery; ?>" data-gallerytable="<?php echo isset($gallerytable) ? $gallerytable : 'gallery'; ?>" data-resize="<?php echo isset($resize) ? $resize : 'FALSE'; ?>" data-width="<?php echo isset($width) ? $width : '2000'; ?>" data-gallerychunk="true" data-height="<?php echo isset($height) ? $height : '1000'; ?>" data-fit="<?php echo isset($fit) ? $fit : 'outside'; ?>" data-galleryname="videos" data-gallerypath="<?php echo isset($path) ? $path : '../userfiles/galeria/'; ?>" data-multilang="<?php echo isset($multilang) && $multilang && is_array($languages) ? 1 : 0; ?>">
        <?php
